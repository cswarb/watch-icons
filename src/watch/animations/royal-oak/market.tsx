...
export const MarketPriceAnimation = (props: any) => {
    ...
    useEffect(() => {
        const data: any[] = [
            { date: '2019-01-01', price: 9750, rrp: 8000 },
            { date: '2019-02-01', price: 7925, rrp: 8000 },
            { date: '2019-03-01', price: 21400, rrp: 10000 },
            { date: '2019-04-01', price: 16500, rrp: 13500 },
            { date: '2019-05-01', price: 19500, rrp: 13500 },
        ];
        cb(data);
    });
