...
export const RadialAnimation = (props: any) => {
    ...
    function cb(dataset: any): void {
        ...
        legend.selectAll('.legend-dot')
            ...
            .attr('cx', (d: any, i: any) => xScale(xAccessor(dataset[dataset.length - 1])) - 30 + (i * 50))
            .attr('cy', (d: any, i: any) => { return yScale(yExtent[0]) + 80 })
            .attr('r', 7)
            .style('fill', (d: any) => {
        ...
        legend.selectAll('legend-label')
            ...
            .attr('y', (d: any, i) => { return yScale(yExtent[0]) + 80 })
            .style('fill', (d: any) => {
    ...
    useEffect(() => {
        const data: any[] = [
            { date: '2019-01-01', hype: 7500 },
            { date: '2019-02-01', hype: 8750 },
            { date: '2019-03-01', hype: 8200 },
            { date: '2019-04-01', hype: 10000 },
            { date: '2019-05-01', hype: 15000 },
        ];
        cb(data);
    });
    ...
    return (
        <div>
            <svg ref={ref}>
                <defs>
                    <linearGradient id="hype" gradientTransform="rotate(90)">
                        <stop offset="0%" stopColor={MAIN_COLOR} />
                        <stop offset="100%" stopColor="#ffffff" stop-opacity="0" />
                    </linearGradient>
                    <linearGradient id="redBlue" x1="0%" y1="0%" x2="0%" y2="100%">
                        <stop offset="0%" stop-color="orange"></stop>
                        <stop offset="100%" stopColor={MAIN_COLOR}></stop>
                    </linearGradient>
                </defs>
            </svg>
        </div>
