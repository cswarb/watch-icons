...
const MAIN_COLOR = '#F0F3F4';

export const SuggestionAnimation = (props: any) => {
    ...
    function cb(dataset: any): void {
        ...
        const yAccessor2 = (d: any) => d.price;
        ...
        const x = stage.append('g').attr('class', 'x-axis x-axis--placeholder').attr('transform', `translate(0, ${dimensions.boundedHeight})`).call(xAxis);
        ...
        const y = stage.append('g').attr('class', 'y-axis y-axis--placeholder').call(yAxis);
    ...
    useEffect(() => {
        const data: any[] = [
            ...
            { date: '2019-03-01', price: 7900 },
            { date: '2019-04-01', price: 9500 },
            { date: '2019-05-01', price: 11250 },
            { date: '2019-06-01', price: 8900 },
        ];
        cb(data);
    });
    ...
    return (
        <div>
            <svg ref={ref}>
                <defs>
                    <linearGradient id="ghost" gradientTransform="rotate(90)">
